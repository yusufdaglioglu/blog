...
Örneğin Microsoft Excel'de (veya herhangi bir yazılım geliştirme ortamında), bir hücrede tarih-saat değeri olsun. Bir alt hücrede bu tarih-saat değerinin 1 saniye sonrasını göstermek istediniz. Eğer alt hücredeki tarih-saat değeri timezone değişikliğine denk geliyor ise, Excel size 1 saat sonrası gösterebilir. Merak eden yazılımcılar buradaki kodu inceleyebilir: <a target='_blank' rel='noopener noreferrer' href='https://github.com/yusufdaglioglu/datetime-egde-case-example/blob/master/src/test/java/com/demo/datetime/TimeZoneChangeTest.java'>https://github.com/yusufdaglioglu/datetime-egde-case-example/blob/master/src/test/java/com/demo/datetime/TimeZoneChangeTest.java</a>
...
<a target='_blank' rel='noopener noreferrer' href='https://github.com/yusufdaglioglu/tutorials/blob/master/tutorials/date_time.md'>https://github.com/yusufdaglioglu/tutorials/blob/master/tutorials/date_time.md</a>
